...
## Documentation
- Update `README.md` whenever a new feature is implemented or after any significant change.
- Document feature overview, setup changes, environment variables, usage steps, and testing instructions.
- Keep `.env.local.example` aligned with current required environment variables.
